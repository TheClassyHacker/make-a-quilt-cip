...
def main():
    ...
    # TODO: your code here for second row
    # repeats the top row pattern
    # draw_square_patch(canvas, 0, PATCH_SIZE)
    # draw_circle_patch(canvas, PATCH_SIZE, PATCH_SIZE)
    # draw_square_patch(canvas, PATCH_SIZE*2, PATCH_SIZE)
    # draw_circle_patch(canvas, PATCH_SIZE*3, PATCH_SIZE)
  
    # makes an alternating pattern
